...
2. **趋势向**：在 [`trends/`](../trends/README.md) 下 `YYYY-MM-DD/index.md`（模板 `templates/template-trend-daily.md`），可用 `index.html` 阅读
3. 快扫标题，只深读 **1 条**
4. 写入当日笔记：`今日趋势 / 对我学习的影响`
5. 周末：删重复订阅，只留 1–2 个主源；合并本周重复的 GitHub 信号
